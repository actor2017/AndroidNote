...
var strShapeName	= "形状名";
var strShapeText	= "形状文本";
var strProps		= "自定义属性";
var strResults		= "搜索结果为:";

var strShape	= "形状名:";
var strNoCustomPropertiesToDisplayText = "按住 Ctrl 键的同时单击绘图中的形状，可以查看详细信息。";
	...
	if (searchTokensArray.length > 0)
	{
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(results_' + lastPageID + '_' + shapeID + ',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" alt="显示/隐藏形状的详细信息" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
