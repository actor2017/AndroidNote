...
public class UIKitConstants {
    ...
    //TUIKit.getBaseConfigs()
    public static String APP_DIR             = TencentImUtils.tencentIMConfigs.getAppCacheDir() != null ?
            TencentImUtils.tencentIMConfigs.getAppCacheDir() : SD_CARD_PATH + "/" + TencentImUtils.context.getPackageName();
