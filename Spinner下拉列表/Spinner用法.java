1.android:Theme.Light很丑,见 "1.Spinner数据源于xml数组" 图片.
...
Object item = spinner.getSelectedItemPosition();  //获取选中的那一项
Object item = spinner.getItemAtPosition(position);//获取指定项
