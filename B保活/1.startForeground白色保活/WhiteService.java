...
public class WhiteService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        startForeground(FOREGROUND_ID, notification);//id 唯一的通知标识
        return return Service.START_STICKY;//super.onStartCommand(intent, flags, startId)
    }
